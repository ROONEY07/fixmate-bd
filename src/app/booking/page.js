...
function BookingPageContent() {
  ...
  // যদি URL-এ সার্ভিস আইডি না থাকে, তবে প্রথম সার্ভিসটি selected থাকবে
  ...
  const handleBookingSubmit = (e) => {
    ...
    const existingBookings = JSON.parse(
      localStorage.getItem("fixmate_bookings") || "[]"
    );
  ...
  return (
    <div className="min-h-screen bg-slate-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        ...
        <Link
          href="/services"
          className="inline-flex items-center gap-2 text-slate-600 hover:text-emerald-600 font-bold text-sm mb-6 transition-colors"
        >
        ...
        <div className="bg-white rounded-3xl p-8 sm:p-10 border border-slate-200 shadow-sm">
          ...
          <p className="text-slate-500 text-sm mb-8">
            Select your required service and provide your details to confirm
            the appointment.
          </p>
          ...
          <form onSubmit={handleBookingSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full py-4 bg-emerald-600 hover:bg-emerald-700 text-white font-bold rounded-2xl text-base shadow-lg shadow-emerald-600/20 transition-all mt-4"
            >
